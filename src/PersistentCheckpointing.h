...
class WriteVmConfig {
public:
  WriteVmConfig(Task* clone_leader, const char* data_dir, size_t buffer_size) noexcept;
 ...
 * |checkpoint_data_dir|
 */
void write_vm(Task* clone_leader, rr::pcp::ProcessSpace::Builder builder, const std::string& checkpoint_data_dir);
